...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LatestEntriesPlugin.blog'
        db.add_column('cmsplugin_latestentriesplugin', 'blog', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cmsplugin_blog.Blog']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LatestEntriesPlugin.blog'
        db.delete_column('cmsplugin_latestentriesplugin', 'blog_id')
    ...
    models = {
        ...
        'cmsplugin_blog.entry': {
            ...
            'blog': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cmsplugin_blog.Blog']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
