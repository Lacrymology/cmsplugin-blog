...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cmsplugin_blog_entry', 'blog', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cmsplugin_blog.Blog']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.blog'
        db.delete_column('cmsplugin_blog_entry', 'blog_id')
